...
public class EmptyingTheCart {
    ...
    public static void main(String[] args) {
        ...
        WebElement webElement6 = driver.findElement(By.xpath(".//p[text()='Wok паназиатский М']/.."));
        webElement6.getText();

        WebElement webElement7 = driver.findElement(By.xpath(".//*[@class='link_underlined']"));
        webElement7.click();

        WebElement webElement8 = driver.findElement(By.xpath(".//*[@class='sw-button' and text()='Очистить']"));
        webElement8.click();

        WebElement webElement9 = driver.findElement(By.xpath(".//*[text()='Твоя корзина пуста ...']"));
        webElement9.getText();
